...
from os import path# Make sure you have the 'EightPuzzleGUI' class defined in 'board.py'

FILE_PATH=path.abspath("2023-2024\week-2\Group A - 8-puzzle depth FS\\solution.txt")
